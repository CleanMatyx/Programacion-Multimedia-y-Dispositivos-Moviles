...
import edu.matiasborra.edumatiasborrademo02.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val itemId : Int = intent.getIntExtra("ITEM_ID", 0)
        if (itemId == 0) {
            finish()
            return
        }
        ...
        // Add a callback to handle the back button
